...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#5857b4f7#;
   ...
   u00010 : constant Version_32 := 16#a3fdee7d#;
   pragma Export (C, u00010, "system__soft_linksS");
   u00011 : constant Version_32 := 16#d0b087d0#;
   pragma Export (C, u00011, "system__secondary_stackB");
   u00012 : constant Version_32 := 16#debd0a58#;
   pragma Export (C, u00012, "system__secondary_stackS");
   u00013 : constant Version_32 := 16#33a162cd#;
   pragma Export (C, u00013, "ada__exceptionsB");
   u00014 : constant Version_32 := 16#00870947#;
   ...
   u00017 : constant Version_32 := 16#42d3e466#;
   ...
   u00019 : constant Version_32 := 16#ec13924a#;
   ...
   u00021 : constant Version_32 := 16#40780307#;
   pragma Export (C, u00021, "system__exceptions_debugS");
   u00022 : constant Version_32 := 16#52e91815#;
   ...
   u00025 : constant Version_32 := 16#8a5c240d#;
   pragma Export (C, u00025, "system__unsigned_typesS");
   u00026 : constant Version_32 := 16#bca88fbc#;
   ...
   u00028 : constant Version_32 := 16#f6ecafe9#;
   ...
   u00030 : constant Version_32 := 16#b86ae4d8#;
   pragma Export (C, u00030, "system__traceback_entriesS");
   u00031 : constant Version_32 := 16#65d5266b#;
   ...
   u00034 : constant Version_32 := 16#26ed0985#;
   pragma Export (C, u00034, "ada__exceptions__tracebackS");
   u00035 : constant Version_32 := 16#f9910acc#;
   pragma Export (C, u00035, "system__address_imageB");
   u00036 : constant Version_32 := 16#d19ac66e#;
   pragma Export (C, u00036, "system__address_imageS");
   u00037 : constant Version_32 := 16#45c8b1f1#;
   pragma Export (C, u00037, "system__img_address_32S");
   u00038 : constant Version_32 := 16#9111f9c1#;
   pragma Export (C, u00038, "interfacesS");
   u00039 : constant Version_32 := 16#68e81073#;
   pragma Export (C, u00039, "system__img_address_64S");
   u00040 : constant Version_32 := 16#fd158a37#;
   pragma Export (C, u00040, "system__wch_conB");
   u00041 : constant Version_32 := 16#a9757837#;
   pragma Export (C, u00041, "system__wch_conS");
   u00042 : constant Version_32 := 16#5c289972#;
   pragma Export (C, u00042, "system__wch_stwB");
   u00043 : constant Version_32 := 16#84645436#;
   pragma Export (C, u00043, "system__wch_stwS");
   u00044 : constant Version_32 := 16#7cd63de5#;
   pragma Export (C, u00044, "system__wch_cnvB");
   u00045 : constant Version_32 := 16#afb5b247#;
   pragma Export (C, u00045, "system__wch_cnvS");
   u00046 : constant Version_32 := 16#e538de43#;
   pragma Export (C, u00046, "system__wch_jisB");
   u00047 : constant Version_32 := 16#1a02d06d#;
   pragma Export (C, u00047, "system__wch_jisS");
   u00048 : constant Version_32 := 16#a43efea2#;
   pragma Export (C, u00048, "system__parametersB");
   u00049 : constant Version_32 := 16#45e1a745#;
   pragma Export (C, u00049, "system__parametersS");
   u00050 : constant Version_32 := 16#0286ce9f#;
   pragma Export (C, u00050, "system__soft_links__initializeB");
   u00051 : constant Version_32 := 16#ac2e8b53#;
   pragma Export (C, u00051, "system__soft_links__initializeS");
   u00052 : constant Version_32 := 16#8599b27b#;
   pragma Export (C, u00052, "system__stack_checkingB");
   u00053 : constant Version_32 := 16#b7294e42#;
   pragma Export (C, u00053, "system__stack_checkingS");
   u00054 : constant Version_32 := 16#c3b32edd#;
   pragma Export (C, u00054, "ada__containers__helpersB");
   u00055 : constant Version_32 := 16#444c93c2#;
   pragma Export (C, u00055, "ada__containers__helpersS");
   u00056 : constant Version_32 := 16#c34b231e#;
   pragma Export (C, u00056, "ada__finalizationS");
   ...
   u00090 : constant Version_32 := 16#7a0a6580#;
   pragma Export (C, u00090, "system__finalization_rootS");
   u00091 : constant Version_32 := 16#52627794#;
   pragma Export (C, u00091, "system__atomic_countersB");
   u00092 : constant Version_32 := 16#ac6eb497#;
   pragma Export (C, u00092, "system__atomic_countersS");
   u00093 : constant Version_32 := 16#553a519e#;
   pragma Export (C, u00093, "system__atomic_primitivesB");
   u00094 : constant Version_32 := 16#78a6d0b7#;
   pragma Export (C, u00094, "system__atomic_primitivesS");
   ...
   u00097 : constant Version_32 := 16#4031e1a0#;
   pragma Export (C, u00097, "ada__containers__stable_sortingB");
   u00098 : constant Version_32 := 16#f29ff792#;
   pragma Export (C, u00098, "ada__containers__stable_sortingS");
   u00099 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00099, "ada__integer_text_ioB");
   u00100 : constant Version_32 := 16#b4dc53db#;
   pragma Export (C, u00100, "ada__integer_text_ioS");
   u00101 : constant Version_32 := 16#27ac21ac#;
   pragma Export (C, u00101, "ada__text_ioB");
   u00102 : constant Version_32 := 16#60f53344#;
   pragma Export (C, u00102, "ada__text_ioS");
   u00103 : constant Version_32 := 16#1cacf006#;
   pragma Export (C, u00103, "interfaces__c_streamsB");
   u00104 : constant Version_32 := 16#d07279c2#;
   pragma Export (C, u00104, "interfaces__c_streamsS");
   u00105 : constant Version_32 := 16#fb523cdb#;
   pragma Export (C, u00105, "system__crtlS");
   u00106 : constant Version_32 := 16#ec2f4d1e#;
   pragma Export (C, u00106, "system__file_ioB");
   u00107 : constant Version_32 := 16#16390e12#;
   pragma Export (C, u00107, "system__file_ioS");
   u00108 : constant Version_32 := 16#ef3c5c6f#;
   pragma Export (C, u00108, "system__finalization_primitivesB");
   u00109 : constant Version_32 := 16#f622319e#;
   pragma Export (C, u00109, "system__finalization_primitivesS");
   u00110 : constant Version_32 := 16#9cd38c2c#;
   pragma Export (C, u00110, "system__os_locksS");
   u00111 : constant Version_32 := 16#8f29e754#;
   pragma Export (C, u00111, "system__os_constantsS");
   u00112 : constant Version_32 := 16#c04dcb27#;
   pragma Export (C, u00112, "system__os_libB");
   u00113 : constant Version_32 := 16#f51dc4c4#;
   pragma Export (C, u00113, "system__os_libS");
   u00114 : constant Version_32 := 16#94d23d25#;
   pragma Export (C, u00114, "system__atomic_operations__test_and_setB");
   u00115 : constant Version_32 := 16#57acee8e#;
   pragma Export (C, u00115, "system__atomic_operations__test_and_setS");
   u00116 : constant Version_32 := 16#b7152171#;
   pragma Export (C, u00116, "system__atomic_operationsS");
   ...
   u00152 : constant Version_32 := 16#f06ce655#;
   pragma Export (C, u00152, "system__task_infoS");
   u00153 : constant Version_32 := 16#45653325#;
   pragma Export (C, u00153, "system__tasking__debugB");
   u00154 : constant Version_32 := 16#efd4ee9a#;
   ...
   u00156 : constant Version_32 := 16#c58d28a3#;
   pragma Export (C, u00156, "system__concat_2S");
   u00157 : constant Version_32 := 16#752a67ed#;
   pragma Export (C, u00157, "system__concat_3B");
   u00158 : constant Version_32 := 16#fa0c42f6#;
   pragma Export (C, u00158, "system__concat_3S");
   u00159 : constant Version_32 := 16#3066cab0#;
   pragma Export (C, u00159, "system__stack_usageB");
   u00160 : constant Version_32 := 16#2e36c345#;
   pragma Export (C, u00160, "system__stack_usageS");
   u00161 : constant Version_32 := 16#20ec7aa3#;
   pragma Export (C, u00161, "system__ioB");
   u00162 : constant Version_32 := 16#ee34ac1b#;
   pragma Export (C, u00162, "system__ioS");
   u00163 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00163, "gnatS");
   u00164 : constant Version_32 := 16#2d4c7e6e#;
   pragma Export (C, u00164, "gnat__semaphoresB");
   u00165 : constant Version_32 := 16#5c785139#;
   pragma Export (C, u00165, "gnat__semaphoresS");
   u00166 : constant Version_32 := 16#3938641c#;
   pragma Export (C, u00166, "system__tasking__protected_objectsB");
   u00167 : constant Version_32 := 16#94fe996c#;
   pragma Export (C, u00167, "system__tasking__protected_objectsS");
   u00168 : constant Version_32 := 16#85efc30a#;
   pragma Export (C, u00168, "system__soft_links__taskingB");
   u00169 : constant Version_32 := 16#13803e06#;
   ...
   u00171 : constant Version_32 := 16#2f594863#;
   pragma Export (C, u00171, "ada__exceptions__is_null_occurrenceS");
   u00172 : constant Version_32 := 16#5cc76ab2#;
   ...
   u00206 : constant Version_32 := 16#06ec70ec#;
   pragma Export (C, u00206, "system__tasking__stagesB");
   u00207 : constant Version_32 := 16#9016fe58#;
   pragma Export (C, u00207, "system__tasking__stagesS");
   u00208 : constant Version_32 := 16#2d236812#;
   pragma Export (C, u00208, "ada__task_initializationB");
   u00209 : constant Version_32 := 16#d7b0c315#;
   pragma Export (C, u00209, "ada__task_initializationS");
   u00210 : constant Version_32 := 16#0ddbd91f#;
   pragma Export (C, u00210, "system__memoryB");
   u00211 : constant Version_32 := 16#68e2c74e#;
